...
<div class="content">
    ...
    <form action="{!!route('admin.supplier.update',['id'=>$supplier->id])!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="email" value="{!!is_null(old('email'))?$supplier->email:old('email')!!}" >
