                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" name="wholesale_price" class="form-control touchspin text-center" value="{!!is_null(old('wholesale_price'))?$record->wholesale_price:old('wholesale_price')!!}">
                                    </div>
                                </div>
                                <div class="form-group row">
