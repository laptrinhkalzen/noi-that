                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="left-icon-tab1">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <fieldset>
                                    <div class="form-group row">
                                        <label class="col-md-2 col-form-label text-right">Mã <span class="text-danger">*</span></label>
                                        <div class="col-md-10">
                            ...
                            <div class="col-md-4">
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4 text-left">Giá gốc</label>
                                    <div class="col-md-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-4 text-left">Giá buôn </label>
                                    <div class="col-md-7">
                                        <input type="text" name="wholesale_price" class="form-control touchspin text-center" value="0">
                                    </div>
                                </div>
                                <div class="form-group row">
