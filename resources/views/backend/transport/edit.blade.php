...
<div class="content">
    ...
    <form action="{!!route('admin.transport.update',['id'=>$transport->id])!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                            ...
                            <div class="col-md-10">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-form-label text-right">Tên đơn vị vận chuyển: <span class="text-danger">*</span></label>
                                        <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            <a type="button" href="{{route('admin.transport.index')}}" class="btn btn-secondary legitRipple">Hủy</a>
