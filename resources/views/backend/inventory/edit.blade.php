...
<div class="content">
    <form action="{!!route('admin.inventory.update',['id'=>$inventory->inventory_id])!!}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h6 class="card-title">Chỉnh sửa phiếu kiểm</h6>
                                ...
                                <fieldset>
                                 ...
                                 @foreach($inventory_products as $inventory_product)
                                   ...
                                   <div class="form-group col-md-3" id="vehicle-type">
                                      <input  readonly  type="text" value="{{$inventory_product->product_id}}" name="product[]"  class="form-control " required="">
                                  </div> 
                                     <div class="form-group col-md-2" >
                                       <input  readonly  type="number" value="{{$inventory_product->exist}}" name="exist[]"  class="form-control quantity-input" required="">
                                     </div>

                                    
                                     <div class="form-group col-md-2" >
                                       <input id="quantity" value="{{$inventory_product->real}}" name="real[]" type="number"  min="1" class="form-control " required="">
                                     </div>

                                    
                                    <div class="form-group col-md-2" >
                               
                                       <input id="total" value="{{$inventory_product->difference}}" name="difference[]" class="form-control qty1" value="" readonly="true">
                                    </div>
                     ...
                     $(document).ready(function() {
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                         <textarea class="form-control"  name="note" rows="4" id="comment">{{$inventory->inventory_note}}</textarea>
                                    </div>
                                </div>
