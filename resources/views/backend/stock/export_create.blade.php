    ...
    <form action="{!!route('admin.import.store')!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
            <div class="card-header header-elements-inline">
                <h6 class="card-title">Chọn kho muốn xuất hàng</h6>
                       ...
                       <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                             @foreach($stocks as $stock)
                                <li style="margin-left: 10px;"><a href="{{route('admin.export.create',['id' => $stock->id])}}">{{$stock->name}}</a></li>
                             @endforeach
                          </ul>
                        </div>
                    </li>
                            ...
                            <div class="col-md-8">
                                ...
                                <fieldset>
                                   ...
                                   <div class="form-group col-md-3" id="vehicle-type">
                                     ...
                                     <div class="form-group col-md-2" >
                                     <input  type="text" value="" name="import_price[]" min="1" class="form-control price price-input" required="">
                                     </div>
                                     <div class="form-group col-md-2" >
